(function() {
  ...
  Timeline = (function() {
    ...
    Timeline.prototype.push = function(value) {
      ...
      if (this.records.length > this.size && this.records.shift()) this.times--;
  ...
  module.exports = function(checkFunc, times, execFunc) {
    var timeline, _ref;
    if ((_ref = this.timelines) == null) this.timelines = [];
    timeline = new Timeline(times);
    this.timelines.push(timeline);
    this.on('new-stat', function() {
      if (timeline.push(checkFunc.call(this))) return execFunc.call(this);
    });
